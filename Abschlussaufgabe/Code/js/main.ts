namespace Endabgabe {
    ...
    let fischeArray: Fische[] = [];
    let luftblasenArray: Luftblasen[] = [];
    ...
    function update(): void {
        ...
        for (let i: number = 0; i < fischeArray.length; i++) {
        ...
        for (let i: number = 0; i < luftblasenArray.length; i++) {
    ...
    function spielerFischBewegungAufhoeren(e: KeyboardEvent) {
        switch (e.keyCode) {
            //links
            case 37:
                spielerfisch.dx = 0;
